...
| --- | ---: | ---: |
| Adjacent client update | 180,353 | 1,444 |
| Non-adjacent client update | 181,583 | 1,444 |
| Membership verification | 129,077 | 2,116 |
| Non-membership verification | 141,497 | 2,020 |
