...
| --- | ---: | ---: |
| Adjacent client update | 179,083 | 1,444 |
| Non-adjacent client update | 180,313 | 1,444 |
| Membership verification | 127,421 | 2,116 |
| Non-membership verification | 139,373 | 2,020 |
