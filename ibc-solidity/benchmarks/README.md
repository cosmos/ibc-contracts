...
| --- | ---: | ---: |
| Adjacent client update | 180,290 | 1,444 |
| Non-adjacent client update | 180,578 | 1,444 |
| Membership verification | 126,871 | 2,148 |
| Non-membership verification | 139,327 | 2,052 |
