...
# Markers that identify machine-generated files. These are matched against the first 10
# lines of a file; headers added to them would be lost on the next regeneration.
GENERATED_MARKERS='Code generated by|DO NOT EDIT|@generated|autogenerated|Autogenerated'
...
is_generated() {
  head -n 10 -- "$1" 2>/dev/null | grep -qE "${GENERATED_MARKERS}"
}
