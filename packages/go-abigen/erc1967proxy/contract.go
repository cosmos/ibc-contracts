...
var ContractMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
func DeployContract(auth *bind.TransactOpts, backend bind.ContractBackend, implementation common.Address, _data []byte) (common.Address, *types.Transaction, *Contract, error) {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(ContractBin), backend, implementation, _data)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
